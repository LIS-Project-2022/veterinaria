<form method="POST" autocomplete="off">
    <div class="row">
        <?php
            ...
            Page::textInput('Contraseña',           'password',         isset($_POST['password']) ? $_POST['password'] : '',                'Ingrese una contraseña', 'text');
            Page::textInput('Confirmar contraseña', 'password_confirm', isset($_POST['password_confirm']) ? $_POST['password_confirm'] : '','Confirme su contraseña', 'text');
